...
The documentation in this repository is organized as follows:

- `docs/` — conceptual and research documentation
- `specs/` — protocol specifications and models
- `src/` — reference implementations and experiments

Each section can be read independently depending on your background.
