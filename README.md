...
Malachite APIs may return structured errors rather than panicking. Consumers should handle errors explicitly and avoid assuming infallible arithmetic operations.
