...
Public APIs in Malachite aim to be stable, but may evolve as the project matures.

Breaking changes are communicated through release notes. Users relying on specific APIs are encouraged to pin exact versions in downstream projects.
