...
Malachite is focused on protocol research and reference implementations.
It is not intended to be a plug-and-play SDK.

The repository is best suited for:
- protocol engineers
- researchers
- contributors exploring design and verification

If you are looking for production-ready tooling, this repository may require additional integration work.
