...
Malachite is designed for use in safety-critical contexts. Users are encouraged to perform independent reviews and audits before relying on the library in production systems.
