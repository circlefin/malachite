...
- **Formal Verification** — Mathematical methods to prove system correctness.
- **Distributed System** — A system composed of multiple communicating nodes.
- **Specification** — A precise description of expected system behavior.
