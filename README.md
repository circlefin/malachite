...
- `/algorithm`: Core consensus state machine and logic.
- `/network`: P2P communication and networking layers.
- `/types`: Common data structures and protocol definitions.
- `/tests`: Integration tests and simulation tools.
