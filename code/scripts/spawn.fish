...
set -x MALACHITE__CONSENSUS__TIMEOUT_PROPOSE "2s"
set -x MALACHITE__CONSENSUS__TIMEOUT_PREVOTE "1s"
set -x MALACHITE__CONSENSUS__TIMEOUT_PRECOMMIT "1s"
...
set -x MALACHITE__TEST__TXS_PER_PART 256
