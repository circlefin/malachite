...
export MALACHITE__CONSENSUS__MAX_BLOCK_SIZE="10MiB"
export MALACHITE__CONSENSUS__TIMEOUT_PROPOSE="120s"
export MALACHITE__CONSENSUS__TIMEOUT_PROPOSE_DELTA="10s"
export MALACHITE__CONSENSUS__TIMEOUT_PREVOTE="20s"
export MALACHITE__CONSENSUS__TIMEOUT_PRECOMMIT="20s"
...
export MALACHITE__TEST__TX_SIZE="1MiB"
