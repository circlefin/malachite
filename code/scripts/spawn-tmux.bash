...
export MALACHITE__VALUE_SYNC__PARALLEL_REQUESTS=5
export MALACHITE__VALUE_SYNC__BATCH_SIZE=5
export MALACHITE__VALUE_SYNC__MAX_RESPONSE_SIZE="512 MiB"
export MALACHITE__CONSENSUS__P2P__RPC_MAX_SIZE="512 MiB"
...
# Set defaults
app_name=${app_name:-"arc-malachitebft-test-app"}
